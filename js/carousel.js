...
class Carousel {
  constructor(el) {
    ...
    this.carouselData = [
      {
        'id': '1',
        'src': '/images/join_us_photos/1.jpg',
      },
      {
        'id': '2',
        'src': '/images/join_us_photos/2.jpg',
      },
      {
        'id': '3',
        'src': '/images/join_us_photos/3.jpg',
      },
      {
        'id': '4',
        'src': '/images/join_us_photos/4.jpg',
      },
      {
        'id': '5',
        'src': '/images/join_us_photos/5.jpg',
      }
    ];
